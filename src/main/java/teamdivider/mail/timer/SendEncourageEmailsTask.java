...
public class SendEncourageEmailsTask extends AbstractEventSpecificEmailTask {

  public static Map<String, SendEmailResult> result = new HashMap<String, SendEmailResult>();

  public SendEncourageEmailsTask(String activityType, int ordinal) {
  ...
  public void run() {
    ...
    for (User user : users) {
      try {
        MailUtil.sendEncourageEmail(user, activityType, ordinal, event);
  ...
  public String getEmailType() {
    return "SendEncourageEmailsTask";
  }
