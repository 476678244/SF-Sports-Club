(function(){
  ...
  sfSport.factory('EmailSender', ['$http', '$q', function($http, $q){
    var URLS = {
      invite    : '/teamdivider/v2/emailInvite',
      encourage : '/teamdivider/v2/scheduleEncourageEmail',
      start_off : '/teamdivider/v2/scheduleGoEmail'
    };
    return {
  ...
  sfSport.factory('ActivityManager', ['$http', '$q', function($http, $q){
    ...
    return {
      // param: enableCache
      getActivityTypes: generate('/teamdivider/v2/activityTypes', function(resp){
        return _.map(resp, function(item){
          return item.name;
        });
      }),
      getJoiningTypes: generate('/teamdivider/v2/activityTypes/joining', function(resp){
        return _.map(resp, function(item){
          return item.name;
        });
      }),
      getActivityType: function (params) {
        return $q(function(resolve, reject){
          $http.get('/teamdivider/v2/activityType', { params: params }).success(function(resp){
            resolve(resp);
          }).error(function(){
            reject();
          });
      ...
      getEvents: generate('/teamdivider/v2/activityTypes', function(resp, params){
        var activity
          , events = [];
        try {
      ...
      // param: {activity}, enableCache
      getLatestEvent: generate('/teamdivider/v2/activityTypes', function(resp, params){
        var activity
          , latest = null;
        try {
          activity = _.find(resp, function(item){
      ...
      joinEvent: function (params) {
        return $q(function(resolve, reject){
          $http.get('/teamdivider/v2/enrollActivityEvent', { params: params }).success(function(resp){
            resolve(resp);
          }).error(function(){
            reject();
          });
      ...
      quitEvent: function (params) {
        return $q(function(resolve, reject){
          $http.get('/teamdivider/v2/quitActivityEvent', { params: params }).success(function(resp){
            resolve(resp);
          }).error(function(){
            reject();
          });
      ...
      withCar: function (params) {
        return $q(function(resolve, reject){
          $http.get('/teamdivider/v2/yesDrivingCar', { params: params }).success(function(resp){
            resolve(resp);
          }).error(function(){
            reject();
          });
      ...
      withoutCar : function (params) {
        return $q(function(resolve, reject){
          $http.get('/teamdivider/v2/noDrivingCar', { params: params }).success(function(resp){
            resolve(resp);
          }).error(function(){
            reject();
          });
      ...
      group: function(id, number, user, regroup){
        return $q(function(resolve, reject){
          $http.get('/teamdivider/v2/fendui', {
            params: {
              eventId: id,
              numberTeams: number,
              username: user,
      ...
      createEvent: function (activity, name, startTime, goTime, description) {
        ...
        return $q(function(resolve, reject){
          $http.post('/teamdivider/v2/addActivityEvent', {
      ...
      addUser: function (email, fullname, avator, types) {
        return $q(function(resolve, reject){
          $http.post('/teamdivider/v2/addUserWithSubscribing', {
            username: email,
            fullname: fullname,
            avator: avator,
	          types: types
      ...
      addGuest: function (guestName, type, ordinal) {
        return $q(function(resolve, reject){
          $http.post('/teamdivider/v2/addGuest', {
            guest: guestName,
            type: type,
            eventId: ordinal 
          }).success(function(){
      ...
      removeGuest: function (guestName, type, ordinal) {
        return $q(function(resolve, reject){
          $http.post('/teamdivider/v2/removeGuest', {
            guest: guestName,
            type: type,
            eventId: ordinal 
          }).success(function(){
      ...
      watch: function (username, type) {
        return $q(function(resolve, reject){
          $http.post('/teamdivider/v2/userSubscribe', {
            type: type,
            username: username
      ...
      unwatch: function (username, type) {
        return $q(function(resolve, reject){
          $http.post('/teamdivider/v2/userUnsubscribe', {
            type: type,
            username: username 
          }).success(function(ret){
            resolve(ret);
      ...
      updateUser: function (username, fullname, types) {
        return $q(function(resolve, reject){
          $http.post('/teamdivider/v2/updateUser', {
            username: username,
            fullname: fullname,
            types: types
          }).success(function(resp){
      ...
      getUser: function (params) {
        return $q(function(resolve, reject){
          $http.get('/teamdivider/v2/user', { params: params }).success(function(resp){
            var users = resp;
            resolve(users[0]);
          }).error(function(){
            reject();
      ...
      notByHisCar: function (params) {
        return $q(function(resolve, reject){
          $http.get('/teamdivider/v2/notByHisCar', { params: params }).success(function(resp){
            resolve(resp);
          }).error(function(){
            reject();
          });
      ...
      isUserInCar: function (params) {
        return $q(function(resolve, reject){
          $http.get('/teamdivider/v2/isUserInCar', { params: params }).success(function(resp){
            resolve(resp);
          }).error(function(){
            reject();
          });
      ...
      deleteEvent: function (params) {
        return $q(function(resolve, reject){
          $http.get('/teamdivider/v2/deleteActivityEvent', { params: params }).success(function(resp){
            resolve(resp);
          }).error(function(){
            reject();
          });
